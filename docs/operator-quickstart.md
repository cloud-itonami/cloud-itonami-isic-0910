# Operator Quickstart — Petroleum Services Contractor Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0910** (`cloud-itonami-isic-0910`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0910.git
cd cloud-itonami-isic-0910
```
...
- Blueprint governor key: `petroleum-services-governor`
- Likely source path: `petroleum_services.governor.cljc`
