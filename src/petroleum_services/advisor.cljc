(ns petroleum-services.advisor
  "PetroleumServicesAdvisor — proposes a petroleum services coordination
  ...
  well-site. The advisor is swappable: `mock-advisor` (deterministic,
  ...
  provenance or high-risk decisions; `petroleum-services.governor` is the
...
(defn- infer
  ...
  {:op op
   ...
   :rationale (str "proposed " (name op) " for contractor " (:client-id request))})
...
(def ^:private system-prompt
  "You are a petroleum services contractor coordination advisor. Given a
   ...
   have. You do NOT make drilling, well-control, or hazmat decisions — those
